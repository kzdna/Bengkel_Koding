<x-layouts.app title="Data Dokter">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('dokter.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-[#2d4499] hover:bg-[#1e2d6b] 
                        ...
                        <tr class="border-b border-slate-100 hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-700">
                                    {{ $item->poli->nama_poli ?? 'Belum Dipilih' }}
                                </span>
                            </td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="inline-flex items-center gap-2">
                                    ...
                                    {{-- Edit --}}
                                    <a href="{{ route('dokter.edit', $item->id) }}" class="inline-flex items-center gap-1 px-3 py-2 
