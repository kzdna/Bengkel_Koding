<x-layouts.guest title="Register">
    ...
    <div class="card bg-base-100 shadow-2xl rounded-2xl w-full max-w-[480px]">
        <div class="card-body p-[40px]">
            ...
            {{-- Error Alert --}}
            @if ($errors->any())
                <div class="alert alert-error mb-4 rounded-xl text-[0.83rem] flex items-start gap-2 text-white bg-error shadow-lg">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                {{-- Submit Button --}}
                <button type="submit" class="btn-primary-gradient w-full py-3 rounded-xl font-bold text-white shadow-lg flex items-center justify-center gap-2">
            ...
            <p class="text-center mt-5 text-[0.83rem] text-slate-400">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="text-[#2d4499] font-bold no-underline hover:underline">Login</a>
            </p>
